 ...
 * @see app/Http/Controllers/Auth/SocialiteController.php:32
 ...
 * @route '/auth/google/callback'
 */
const handleGoogleCallbackForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
