 ...
 */
export const toggleVerifyOrganization = (
...
toggleVerifyOrganization.url = (
    ...
    return (
        toggleVerifyOrganization.definition.url
 ...
 * @route '/admin/organizations/{id}/verify'
 */
toggleVerifyOrganization.patch = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'patch'> => ({
    url: toggleVerifyOrganization.url(args, options),
 ...
 * @route '/admin/organizations/{id}/verify'
 */
const toggleVerifyOrganizationForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
 ...
 * @route '/admin/organizations/{id}/verify'
 */
toggleVerifyOrganizationForm.patch = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: toggleVerifyOrganization.url(args, {
 ...
 */
export const toggleVerifyCandidate = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteDefinition<'patch'> => ({
...
toggleVerifyCandidate.url = (
    ...
    return (
        toggleVerifyCandidate.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/admin/candidates/{id}/verify'
 */
const toggleVerifyCandidateForm = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/candidates/{id}/verify'
 */
toggleVerifyCandidateForm.patch = (
    args: { id: string | number } | [id: string | number] | string | number,
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: toggleVerifyCandidate.url(args, {
 ...
 */
export const createProxyCandidate = (
    options?: RouteQueryOptions,
 ...
 * @route '/admin/candidates/proxy'
 */
const createProxyCandidateForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 */
export const updateCriteriaWeights = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/criteria/weights'
 */
const updateCriteriaWeightsForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/criteria/weights'
 */
updateCriteriaWeightsForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: updateCriteriaWeights.url(options),
    method: 'post',
...
const AgencyDashboardController = {
    index,
    toggleVerifyOrganization,
    toggleVerifyCandidate,
