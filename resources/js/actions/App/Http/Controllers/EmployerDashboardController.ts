 ...
 */
export const candidatePortalSwitch = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/candidate/portal-switch'
 */
const candidatePortalSwitchForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/candidate/portal-switch'
 */
candidatePortalSwitchForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
